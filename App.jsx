...
const recommendations = [
  { name: "Lotfi Hamadi", role: "Founder of #WallahWeCan", quote: "Un pro de la com qui a compris la différence entre efficacité et efficience. Il a toujours répondu à nos demandes à temps et avec de la qualité." },
  { name: "Wassim Ben Ammar", role: "UI/UX Designer, Motion & Graphic Designer, Software Engineer", quote: "Ala combine brillamment son esprit entrepreneurial avec ses études pour offrir des stratégies de communication innovantes et percutantes." },
  { name: "Tarek Soussi", role: "CEO-Manager chez Oeil Des Cyclopes", quote: "Nous recommandons vivement Alaa pour son expertise en communication digitale et sa maîtrise exemplaire des réseaux sociaux." },
  { name: "Bilel Amdouni", role: "Digital Marketing & Transformation Consultant", quote: "Alaa s'est distingué par son professionnalisme, sa curiosité intellectuelle et sa volonté permanente de monter en compétences." },
];
    ...
    <main className="min-h-screen bg-[#F6F1E8] text-[#111827]">
        ...
        <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-5 py-6 md:px-8">
          <nav className="flex items-center justify-between rounded-full border border-white/70 bg-white/65 px-5 py-3 shadow-sm backdrop-blur-xl">
            ...
            <div className="hidden items-center gap-7 text-sm font-medium text-[#526071] lg:flex">
              ...
              <a href="#projects" className="hover:text-[#143A5A]">Projects</a>
            ...
            <a href={`mailto:${email}`} className="rounded-full bg-[#143A5A] px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:bg-[#0F2B42]">Contact</a>
          </nav>
          ...
          <div id="top" className="grid flex-1 items-center gap-10 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:py-16">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a href={linkedInUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-[#D5BD90] bg-white/75 px-6 py-3 font-semibold text-[#143A5A] shadow-sm">LinkedIn profile</a>
              </div>
            </div>
            ...
            <div className="relative mx-auto w-full max-w-[420px]">
              <div className="relative rounded-[2.5rem] border border-white/80 bg-white/70 p-4 shadow-2xl">
                <div className="relative overflow-hidden rounded-[2rem] bg-[#143A5A] p-7 text-white">
                  ...
                  <h2 className="mx-auto mt-4 max-w-sm text-center text-3xl font-black leading-tight">Marketing profile for hospitality, tourism & brand image</h2>
      ...
      <section id="about" className="mx-auto max-w-7xl px-5 py-20 md:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr]">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black leading-tight tracking-[-0.04em] md:text-5xl">Independent, creative and results-driven.</h2>
          </div>
          <div className="rounded-[2rem] border border-[#E3D5BF] bg-white/75 p-8 shadow-sm">
            <p className="text-lg leading-8 text-[#4B5563]">I combine hospitality management, communication strategy and hands-on field experience to help brands improve visibility, guest acquisition, customer loyalty and brand consistency.</p>
            <p className="mt-5 text-lg leading-8 text-[#4B5563]">My work is focused on meaningful storytelling, practical execution and measurable results across hospitality, tourism, communications and experience-led projects.</p>
          </div>
        </div>
      </section>
      ...
      <section id="experience" className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {experiences.map((item) => (
            <article key={item.company} className="rounded-[2rem] border border-[#E3D5BF] bg-white/75 p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
              <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#143A5A] text-white"><Briefcase size={22} /></div>
      ...
      <section id="projects" className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        <div className="mb-12 max-w-3xl">
          <p className="text-sm font-black uppercase tracking-[0.3em] text-[#8A6D3B]">Projects & Collaborations</p>
          <h2 className="mt-4 text-4xl font-black tracking-[-0.04em] md:text-5xl">Projects I founded and organizations I collaborated with</h2>
        </div>

        <div className="mb-14">
          <div className="mb-6">
            <p className="text-sm font-black uppercase tracking-[0.3em] text-[#8A6D3B]">Projects I Founded</p>
            <h3 className="mt-3 text-3xl font-black tracking-[-0.03em] text-[#111827]">Entrepreneurial initiatives</h3>
          </div>
        ...
        <div>
          <div className="mb-6">
            <p className="text-sm font-black uppercase tracking-[0.3em] text-[#8A6D3B]">Organizations I Collaborated With</p>
            <h3 className="mt-3 text-3xl font-black tracking-[-0.03em] text-[#111827]">Professional collaborations</h3>
          </div>
        ...
        <div className="mt-16">
          <div className="mb-8">
            ...
            <h3 className="mt-3 text-3xl font-black tracking-[-0.03em] text-[#111827]">Clients I managed through BoostCom</h3>
          </div>
          <div className="relative overflow-hidden rounded-[2rem] border border-[#E3D5BF] bg-white/70 py-6 shadow-sm">
            <style>{`@keyframes clients-scroll { from { transform: translateX(0); } to { transform: translateX(-50%); } } .clients-track { animation: clients-scroll 26s linear infinite; } .clients-track:hover { animation-play-state: paused; }`}</style>
      ...
      <section id="international" className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        <div className="mb-10 max-w-3xl">
          ...
          <h2 className="mt-4 text-4xl font-black tracking-[-0.04em] md:text-5xl">Learning across cultures and contexts</h2>
        </div>
        <div className="grid gap-6 md:grid-cols-2">
          {internationalExperiences.map((item) => (
            <article key={item.title} className="overflow-hidden rounded-[2rem] border border-[#E3D5BF] bg-white/80 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
              <div className="relative h-72 bg-[#D8C39F]/30">
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#143A5A] to-[#C3A36C] text-white"><Plane size={44} /></div>
      ...
      <section id="skills" className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        <div className="rounded-[2rem] border border-[#E3D5BF] bg-white/75 p-7 shadow-sm">
          <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#143A5A] text-white"><Globe2 size={24} /></div>
          <p className="text-sm font-black uppercase tracking-[0.3em] text-[#8A6D3B]">Skills</p>
          <h2 className="mt-4 text-4xl font-black tracking-[-0.04em] md:text-5xl">Core professional skills</h2>
          <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            {skills.map((skill) => (
              <div key={skill} className="rounded-full border border-[#E3D5BF] bg-[#F8F4EC] px-4 py-2 text-sm font-semibold text-[#4B5563]">{skill}</div>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        <div className="rounded-[2.5rem] border border-[#E3D5BF] bg-white/75 p-8 shadow-sm md:p-10">
          <div className="mb-8 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#143A5A] text-white"><Users size={24} /></div>
            <div><p className="text-sm font-black uppercase tracking-[0.3em] text-[#8A6D3B]">Volunteer experiences</p><h2 className="text-3xl font-black tracking-[-0.03em]">Community, leadership and impact</h2></div>
          </div>
          <div className="grid gap-5 md:grid-cols-3">
            {[
              ["Rotary Family", "Interact Tunis César → Rotaract Tunis César → Rotary Sidi Bou Said. Community service, humanitarian projects, fundraising and partner outreach."],
              ...
              <div key={title} className="rounded-[1.75rem] bg-[#F8F4EC] p-6"><h3 className="text-xl font-black text-[#143A5A]">{title}</h3><p className="mt-3 leading-7 text-[#5B6472]">{text}</p></div>
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="recommendations" className="overflow-hidden py-20">
        ...
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="mb-10"><p className="text-sm font-black uppercase tracking-[0.3em] text-[#8A6D3B]">Recommendations</p><h2 className="mt-4 text-4xl font-black tracking-[-0.04em] md:text-5xl">What people say about working with me</h2></div>
        </div>
        <div className="recommendation-track flex w-max gap-5 px-5 md:px-8">
          {[...recommendations, ...recommendations].map((item, index) => (
            <article key={`${item.name}-${index}`} className="w-[330px] shrink-0 rounded-[2rem] border border-[#E3D5BF] bg-white/80 p-7 shadow-sm md:w-[520px]">
              <div className="mb-5 flex items-center justify-between"><Quote size={22} className="text-[#143A5A]" /><div className="flex gap-1 text-[#C3A36C]">{[1, 2, 3, 4, 5].map((star) => (<Star key={star} size={15} fill="currentColor" />))}</div></div>
              <p className="text-base leading-7 text-[#4B5563]">“{item.quote}”</p>
              <div className="mt-6 border-t border-[#E3D5BF] pt-5"><h3 className="font-black">{item.name}</h3><p className="mt-1 text-sm font-semibold text-[#143A5A]">{item.role}</p></div>
            </article>
          ))}
        </div>
      </section>
      ...
      <section id="contact" className="mx-auto max-w-7xl px-5 py-20 md:px-8">
        <div className="overflow-hidden rounded-[2.5rem] bg-[#111827] shadow-2xl">
          <div className="grid gap-10 p-8 text-white md:p-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div><p className="text-sm font-black uppercase tracking-[0.3em] text-[#D8C39F]">Contact</p><h2 className="mt-4 text-4xl font-black leading-tight tracking-[-0.04em] md:text-6xl">Let’s connect and build meaningful projects.</h2><p className="mt-5 max-w-2xl text-lg leading-8 text-white/70">Open to hospitality, tourism, communications, marketing, partnerships and customer-experience opportunities.</p></div>
            <div className="space-y-3">
              <a href={`mailto:${email}`} className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-5 py-4 text-white"><Mail size={20} /> {email}</a>
              <a href="tel:+21698606395" className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-5 py-4 text-white"><Phone size={20} /> {phone}</a>
              <a href={linkedInUrl} target="_blank" rel="noreferrer" className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-5 py-4 text-white"><Linkedin size={20} /> LinkedIn profile</a>
              <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-5 py-4 text-white/70"><MapPin size={20} /> Tunisia</div>
            </div>
          </div>
        </div>
      </section>

      <footer className="mx-auto max-w-7xl px-5 pb-10 text-center text-sm text-[#6B7280] md:px-8">© 2026 Ben Mahmoud Alaa. Personal website.</footer>
    </main>
  );
}
